...
if (WebUI.verifyElementVisible(findTestObject('Regression BackOffice/CLINK-30891/Group Bill Rates'))== true)
{
...
WebUI.waitForElementPresent(findTestObject('Regression BackOffice/CLINK-30886/a_UltimaFecha'), 50)

WebUI.click(findTestObject('Regression BackOffice/CLINK-30886/a_UltimaFecha'))
...
if (WebUI.verifyElementNotChecked(findTestObject('Regression BackOffice/CLINK-30891/input_Authorization Group_chkNoAuthorizationRequired'), 
    10)) {
...
not_run: if (WebUI.verifyElementNotChecked(findTestObject('Regression BackOffice/CLINK-30891/Authorization Time Frame'), 
    10)) {
