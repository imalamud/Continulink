...
WebUI.waitForElementPresent(findTestObject('Regression BackOffice/CLNK-23449/CloseButton'), 50)

WebUI.click(findTestObject('Regression BackOffice/CLNK-23449/CloseButton'), FailureHandling.STOP_ON_FAILURE)
