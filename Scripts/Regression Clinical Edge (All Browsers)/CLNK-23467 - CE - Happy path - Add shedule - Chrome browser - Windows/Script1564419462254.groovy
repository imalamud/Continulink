...
WebUI.sendKeys(findTestObject('Regression Clinical Edge/CLINK-23314/StartTime'), '0005')
...
WebUI.sendKeys(findTestObject('Regression Clinical Edge/CLINK-23314/EndTime'), '0025')
