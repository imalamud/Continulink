...
WebUI.waitForElementPresent(findTestObject('Regression Clinical Edge/CLINK-23467/a_Scheduled'), 50)

WebUI.verifyElementPresent(findTestObject('Regression Clinical Edge/CLINK-23467/a_Scheduled'), 50)
