...
WebUI.waitForElementPresent(findTestObject('Regression Clinical Edge/CLNK-29105/Punch Out'), 50)

WebUI.click(findTestObject('Regression Clinical Edge/CLNK-29105/Punch Out'))
